...
import com.team16488.library.subsystems.PlatformHook;
...
public class Robot {
    ...
    public PlatformHook platformHook;
    ...
    public Robot(OpMode opMode, Telemetry telemetry){
        ...
        try{
            platformHook = new PlatformHook(opMode.hardwareMap);
            subsystems.add(platformHook);
        }catch(IllegalArgumentException e){}
